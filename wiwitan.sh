...
rm -rf "$SCRIPT_DIR/device/xiaomi/miuicamera-sweet"
rm -rf "$SCRIPT_DIR/vendor/xiaomi/miuicamera-sweet"
...
git clone --depth=1 https://github.com/PixelOS-Devices/device_xiaomi_miuicamera-sweet.git "$SCRIPT_DIR/device/xiaomi/miuicamera-sweet"
git clone --depth=1 https://github.com/PixelOS-Devices/vendor_xiaomi_miuicamera-sweet.git "$SCRIPT_DIR/vendor/xiaomi/miuicamera-sweet"
