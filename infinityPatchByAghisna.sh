...
PATCH_URL="https://raw.githubusercontent.com/Aghisna-Project/Anu/main/0001-version-separate.patch"
PATCH_FILE="0001-version-separate.patch"
...
echo "Mengunduh patch dan terapkan"
curl -L -o "$PATCH_FILE" "$PATCH_URL"
mv "$PATCH_FILE" "$PATCH_DEST"
cd "$SCRIPT_DIR/vendor/infinity/config"
git am "PATCH_FILE"
